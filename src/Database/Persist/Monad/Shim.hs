...
get
  :: (PersistRecordBackend record SqlBackend, Typeable record, MonadSqlQuery m, SafeToInsert record)
...
belongsTo
  :: (PersistEntity record1, PersistRecordBackend record2 SqlBackend, Typeable record1, Typeable record2, MonadSqlQuery m, SafeToInsert (record1, record2))
...
getByValue
  :: (PersistRecordBackend record SqlBackend, AtLeastOneUniqueKey record, Typeable record, MonadSqlQuery m, SafeToInsert record)
...
upsert
  :: (PersistRecordBackend record SqlBackend, OnlyOneUniqueKey record, Typeable record, MonadSqlQuery m, SafeToInsert record)
...
replaceUnique
  :: (PersistRecordBackend record SqlBackend, Eq (Unique record), Eq record, Typeable record, MonadSqlQuery m, SafeToInsert record)
...
selectSourceRes
  :: (MonadIO m2, PersistRecordBackend record SqlBackend, Typeable record, MonadSqlQuery m, SafeToInsert record)
...
selectSource
  :: (PersistRecordBackend record SqlBackend, MonadResource m, Typeable record, MonadSqlQuery m, SafeToInsert record)
...
deleteCascade
  :: (DeleteCascade record SqlBackend, Typeable record, MonadSqlQuery m, SafeToInsert record)
  => Key record -> m ()
